...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://zarik:0000@localhost/iot-test-db'
db = SQLAlchemy(app)
ma = Marshmallow(app)
...
class BuildingsSchema(ma.Schema):
    class Meta:
        fields = ('id', 'name', 'price', 'country', 'year', 'capasity', 'purpose', 'size_in_sq_m')
